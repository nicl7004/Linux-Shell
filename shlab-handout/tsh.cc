...
void eval(char *cmdline)
{
  //path to command that we want to execute usually comes first
...
{
  //string cmd(argv[0]);
  //look in the first spot of argv and then compare to quit command, exit if true
